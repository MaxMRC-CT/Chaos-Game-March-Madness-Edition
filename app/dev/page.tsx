  ...
  return (
    <main className="min-h-dvh bg-[#111827] text-neutral-100">
      <div className="mx-auto max-w-2xl space-y-6 p-6">
        <h1 className="text-2xl font-semibold tracking-tight">Dev Panel</h1>
        ...
        <section className="rounded-xl border border-[#1f2937] bg-[#0f1623] p-4">
          ...
          {progress ? (
            ...
            <p className="text-sm text-neutral-500">League not found or no games yet.</p>
          ) : null}
          <div className="flex gap-2">
            <button
              onClick={fetchProgress}
              disabled={!key.trim() || !/^\d{6}$/.test(code) || progressLoading}
            ...
            <button
              ...
              disabled={!key.trim() || !/^\d{6}$/.test(code) || !!loading}
        ...
        <section className="rounded-xl border border-[#1f2937] bg-[#0f1623] p-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              onClick={() =>
                callApi("/api/dev/reset-pre-draft", { code, year })
              }
              disabled={!key || !!loading}
        ...
        <section className="rounded-xl border border-[#1f2937] bg-[#0f1623] p-4">
          ...
          <p className="mb-2 text-xs text-neutral-500">
            Set League.championshipTotalPoints for tiebreak testing. League PIN: {code}
          </p>
        ...
        <section className="rounded-xl border border-[#1f2937] bg-[#0f1623] p-4">
          <h2 className="mb-3 text-base font-medium text-neutral-200">
            Apply Results (Simulate Tournament)
          </h2>
          <div className="mb-3 flex flex-wrap gap-4">
            <div>
          ...
          <div className="mb-2">
            ...
            <p className="mt-1 text-xs text-neutral-500">
              Paste winners in bracket order for that round.
            </p>
          </div>
          {applyError && (
        ...
        <section className="rounded-xl border border-[#1f2937] bg-[#0f1623] p-4">
          ...
          <div className="mb-3 flex flex-wrap items-center gap-4">
            ...
            >
              {loading === "/api/dev/simulate" ? "Simulating…" : "Simulate Whole Tournament"}
            </button>
          </div>
          {simulateError && (
            <div className="mb-3 rounded-lg border border-rose-700 bg-rose-900/30 px-3 py-2 text-sm text-rose-200">
