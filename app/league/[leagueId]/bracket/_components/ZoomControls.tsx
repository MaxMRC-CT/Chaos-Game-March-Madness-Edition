...
const pillBase =
  "inline-flex h-7 min-w-[2.25rem] items-center justify-center rounded-lg border px-2 text-[11px] font-medium outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-900";
const pillActive =
