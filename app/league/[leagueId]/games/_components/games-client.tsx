    ...
    <main className="min-h-dvh min-w-0 overflow-x-hidden text-neutral-100">
      <div className="mx-auto flex min-w-0 max-w-[1600px] gap-4 p-4">
        ...
        <div className="min-w-0 flex-1 space-y-4">
          ...
          <section className="rounded-2xl border border-white/10 bg-neutral-900/95 p-4 shadow-lg shadow-black/20 sm:p-5">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {([
                ...
                <button
                  ...
                  className={`inline-flex min-h-9 items-center gap-1 rounded-full border px-3 py-1.5 text-[11px] font-medium ${
                    filter === value
